...
\geometry{
  ...
  headheight=0pt,
  headsep=0mm,
  footskip=5mm % Номер страницы аккуратно встает в нижнее поле 7.5мм
  % includeheadfoot УБРАЛИ, чтобы освободить место под текст
}
\linespread{0.97} % Чуть-чуть уплотнили строки
\raggedbottom
\sloppy
...
% --- Оставляем скрытие глав (как у тебя сейчас) ---
\titleformat{\chapter}[block]{\startnewchapter}{} {0pt}{\prechaptercmd}
\titlespacing*{\chapter}{0pt}{0pt}{0pt}
\newcommand{\startnewchapter}{} 
\newcommand{\prechaptercmd}[1]{}

% --- Перенос каждой секции на новую страницу (для разделения билетов) ---
% Эту команду важно сохранить, titlesec автоматически выполняет её перед каждым \section
\newcommand{\sectionbreak}{\clearpage}

% --- НАСТРОЙКА SECTION: Крупный шрифт ---
% \Large делает шрифт заголовка (и номера 1.1, 2.3) заметно больше основного текста 14pt.
% Если захочется сделать ЕЩЁ крупнее, замени \Large на \huge
\titleformat{\section}{\Large\bfseries}{\thesection}{0.5em}{}

% --- НАСТРОЙКА ОТСТУПОВ ДЛЯ SECTION ---
% 1-й параметр (0pt) — отступ слева.
% 2-й параметр (2pt) — отступ сверху от края страницы (так как срабатывает \clearpage).
% 3-й параметр (2pt) — отступ снизу до начала текста (минимальный, чтобы текст не прилипал, но и место не тратилось).
...
% Настраиваем компактные отступы для теорем/определений: 
% 3pt сверху, 3pt снизу, без отступа слева, полужирный заголовок, точка после имени
\newtheoremstyle{compactthm}
  {3pt}% Отступ сверху
  {3pt}% Отступ снизу
  {\itshape}% Шрифт тела (plain)
  {}% Отступ слева
  {\bfseries}% Шрифт заголовка
  {.}% Знак после заголовка
  {.5em}% Пробел после заголовка
  {}% Спецификация заголовка

\newtheoremstyle{compactdef}
  {3pt}% Отступ сверху
  {3pt}% Отступ снизу
  {\normalfont}% Шрифт тела (definition)
  {}% Отступ слева
  {\bfseries}% Шрифт заголовка
  {.}% Знак после заголовка
  {.5em}% Пробел после заголовка
...
% Скрываем визуальное отображение \chapter
\titleformat{\chapter}[block]{\startnewchapter}{} {0pt}{\prechaptercmd}
\titlespacing*{\chapter}{0pt}{0pt}{0pt}

% Вспомогательные команды для скрытия главы
\newcommand{\startnewchapter}{\clearpage} % Начинаем главу с новой страницы (как обычно)
\newcommand{\prechaptercmd}[1]{}         % Полностью игнорируем текст названия главы