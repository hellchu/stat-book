...
% Применяем новые компактные стили к твоим структурам
\renewcommand{\qedsymbol}{$\\square$}\r
\renewcommand*{\\proofname}{Доказательство}\r
\r
\theoremstyle{compactdef}\r
\newtheorem*{defn}{Определение}\r
\newtheorem*{exmp}{Пример}\r
\newtheorem*{symb}{Обозначение}\r
\newtheorem*{rmrk}{Замечание}\r
\newtheorem*{task}{Задача}\r
\r
\theoremstyle{compactthm}\r
\newtheorem*{thm*}{Утверждение}\r
\newtheorem*{lem}{Лемма}\r
\newtheorem*{crlr}{Следствие}\r
\r
\newtheoremstyle{named}{}{}{\\itshape}{}{\\bfseries}{.}{.5em}{\\thmnote{#3}}\r
\theoremstyle{named}\r
